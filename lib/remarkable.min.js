/*! remarkable 1.6.0 https://github.com/jonschlinkert/remarkable @license MIT */ (function (
    f
) {
    ...
    })(
        {
            ...
            3: [
                function (require, module, exports) {
                    ...
                    var attr_value = replace(
                        /(?:unquoted|single_quoted|double_quoted)/
                    )("unquoted", unquoted)("single_quoted", single_quoted)(
                        "double_quoted",
                        double_quoted
                    )();

                    var attribute = replace(
                        /(?:\s+attr_name(?:\s*=\s*attr_value)?)/
                    )("attr_name", attr_name)("attr_value", attr_value)();

                    var open_tag = replace(
                    ...
                    var HTML_TAG_RE = replace(
                        ...
                        "comment",
                        comment
                    )("processing", processing)("declaration", declaration)(
                        "cdata",
                        cdata
                    )();
            ...
            9: [
                function (require, module, exports) {
                    ...
                    var replaceEntities =
                        require("../common/utils").replaceEntities;
            ...
            16: [
                function (require, module, exports) {
                    ...
                    var _rules = [
                        ...
                        [
                            "footnote_tail",
                            require("./rules_core/footnote_tail"),
                        ],
            ...
            17: [
                function (require, module, exports) {
                    ...
                    var _rules = [
                        ...
                        [
                            "footnote_inline",
                            require("./rules_inline/footnote_inline"),
                        ],
                        [
                            "footnote_ref",
                            require("./rules_inline/footnote_ref"),
                        ],
                    ...
                    function validateLink(url) {
                        ...
                        if (
                            str.indexOf(":") !== -1 &&
                            BAD_PROTOCOLS.indexOf(str.split(":")[0]) !== -1
                        ) {
                            return false;
                        }
                        return true;
            ...
            19: [
                function (require, module, exports) {
                    ...
                    Ruler.prototype.before = function (
                        ...
                        if (idx === -1) {
                            throw new Error(
                                "Parser rule not found: " + beforeName
                            );
                        }
                    ...
                    Ruler.prototype.after = function (
                        ...
                        if (idx === -1) {
                            throw new Error(
                                "Parser rule not found: " + afterName
                            );
                        }
            ...
            20: [
                function (require, module, exports) {
                    ...
                    rules.fence = function (
                        ...
                        if (token.params) {
                            ...
                            if (has(instance.rules.fence_custom, fenceName)) {
                                return instance.rules.fence_custom[fenceName](
                                    tokens,
                                    idx,
                                    options,
                                    env,
                            ...
                            langName = escapeHtml(
                                replaceEntities(unescapeMd(fenceName))
                            );
                            langClass =
                                ' class="' + langPrefix + langName + '"';
                        }
                    ...
                    rules.ordered_list_open = function (
                        tokens,
                        idx /*, options, env */
                    ) {
                        var token = tokens[idx];
                    ...
                    rules.paragraph_close = function (
                        tokens,
                        idx /*, options, env */
                    ) {
                        var addBreak = !(
                    ...
                    rules.image = function (tokens, idx, options /*, env */) {
                        ...
                        var alt =
                            ' alt="' +
                            (tokens[idx].alt
                                ? escapeHtml(replaceEntities(tokens[idx].alt))
                                : "") +
                            '"';
                    ...
                    rules.sub = function (tokens, idx /*, options, env */) {
                        return (
                            "<sub>" + escapeHtml(tokens[idx].content) + "</sub>"
                        );
                    };
                    rules.sup = function (tokens, idx /*, options, env */) {
                        return (
                            "<sup>" + escapeHtml(tokens[idx].content) + "</sup>"
                        );
                    };
                    ...
                    var getBreak = (rules.getBreak = function getBreak(
                        tokens,
                        idx
                    ) {
            ...
            21: [
                function (require, module, exports) {
                    ...
                    module.exports = function blockquote(
                        ...
                        terminatorRules =
                            state.parser.ruler.getRules("blockquote");
            ...
            23: [
                function (require, module, exports) {
                    ...
                    function markTightParagraphs(state, idx) {
                        ...
                        for (
                            i = idx + 2, l = state.tokens.length - 2;
                            i < l;
                            i++
                        ) {
                            if (
                    ...
                    module.exports = function deflist(
                        state,
                        startLine,
                        endLine,
                        silent
                        ...
                        OUTER: for (;;) {
                            ...
                            for (;;) {
                                ...
                                oldParentType = state.parentType;
                                state.blkIndent = state.ddIndent =
                                    state.tShift[ddLine] + 2;
                                state.tShift[ddLine] =
                                    contentStart - state.bMarks[ddLine];
                                state.tight = true;
                                state.parentType = "deflist";

                                state.parser.tokenize(
                                    state,
                                    ddLine,
                                    endLine,
                                    true
            ...
            24: [
                function (require, module, exports) {
                    ...
                    module.exports = function fences(
                        state,
                        startLine,
                        endLine,
                        silent
                        ...
                        for (;;) {
                            ...
                            if (
                                pos < max &&
                                state.tShift[nextLine] < state.blkIndent
                            ) {
            ...
            25: [
                function (require, module, exports) {
                    ...
                    module.exports = function footnote(
                        state,
                        startLine,
                        endLine,
                        silent
            ...
            26: [
                function (require, module, exports) {
                    ...
                    module.exports = function heading(
                        ...
                        if (
                            tmp > pos &&
                            state.src.charCodeAt(tmp - 1) === 0x20 /* space */
                        ) {
                            max = tmp;
                        }
            ...
            28: [
                function (require, module, exports) {
                    ...
                    module.exports = function htmlblock(
                        state,
                        startLine,
                        endLine,
                        silent
            ...
            29: [
                function (require, module, exports) {
                    ...
                    module.exports = function lheading(
                        state,
                        startLine,
                        endLine /*, silent*/
                    ) {
                        ...
                        state.tokens.push({
                            type: "inline",
                            content: state.src
                                .slice(pos, state.eMarks[startLine])
                                .trim(),
                            level: state.level + 1,
                ...
                function (require, module, exports) {
                    ...
                    module.exports = function list(
                        ...
                        if (
                            ...
                            (posAfterMarker = skipBulletListMarker(
                                state,
                                startLine
                            )) >= 0
                        ) {
                        ...
                        markerCharCode = state.src.charCodeAt(
                            posAfterMarker - 1
                        );
                ...
                function (require, module, exports) {
                    ...
                    module.exports = function paragraph(
                        ...
                        if (nextLine < endLine && !state.isEmpty(nextLine)) {
                            terminatorRules =
                                state.parser.ruler.getRules("paragraph");
            ...
            32: [
                function (require, module, exports) {
                    ...
                    function StateBlock(src, parser, options, env, tokens) {
                        ...
                        for (
                            start = pos = indent = 0, len = s.length;
                            pos < len;
                            pos++
                        ) {
                            ch = s.charCodeAt(pos);
                    ...
                    StateBlock.prototype.isEmpty = function isEmpty(line) {
                        return (
                            this.bMarks[line] + this.tShift[line] >=
                            this.eMarks[line]
                        );
                    };

                    StateBlock.prototype.skipEmptyLines =
                        function skipEmptyLines(from) {
                    ...
                    StateBlock.prototype.getLines = function getLines(
                        ...
                        if (line + 1 === end) {
                            first =
                                this.bMarks[line] +
                                Math.min(this.tShift[line], indent);
                            last = keepLastLF
                                ? this.eMarks[line] + 1
                                : this.eMarks[line];
            ...
            34: [
                function (require, module, exports) {
                    ...
                    function parseAbbr(str, parserInline, options, env) {
                        ...
                        if (
                            typeof env.abbreviations[":" + label] ===
                            "undefined"
                        ) {
                    ...
                    module.exports = function linkify(state) {
                        ...
                        for (j = 0, l = blockTokens.length; j < l; j++) {
                            ...
                            for (i = tokens.length - 1; i >= 0; i--) {
                                ...
                                if (
                                    token.type === "text" &&
                                    LINK_SCAN_RE.test(token.content)
                                ) {
                ...
                function (require, module, exports) {
                    ...
                    module.exports = function backticks(state, silent) {
                        ...
                        while (
                            ...
                            while (
                                matchEnd < max &&
                                state.src.charCodeAt(matchEnd) === 0x60 /* ` */
                            ) {
                                matchEnd++;
                            }
            ...
            45: [
                function (require, module, exports) {
                    ...
                    module.exports = function del(state, silent) {
                        ...
                        lastChar =
                            start > 0 ? state.src.charCodeAt(start - 1) : -1;
                        ...
                        while (state.pos + 1 < max) {
                            if (
                                state.src.charCodeAt(state.pos) === 0x7e /* ~ */
                            ) {
                                if (
                                    state.src.charCodeAt(state.pos + 1) ===
                                    0x7e /* ~ */
                                ) {
                                    lastChar = state.src.charCodeAt(
                                        state.pos - 1
                                    );
                                    nextChar =
                                        state.pos + 2 < max
                                            ? state.src.charCodeAt(
                                                  state.pos + 2
                                              )
                                            : -1;
                                    if (
                ...
                function (require, module, exports) {
                    ...
                    function scanDelims(state, start) {
                        ...
                        if (count >= 4) {
                            ...
                            nextChar =
                                pos < max ? state.src.charCodeAt(pos) : -1;
            ...
            47: [
                function (require, module, exports) {
                    ...
                    var has = require("../common/utils").has;
                    var isValidEntityCode =
                        require("../common/utils").isValidEntityCode;
                    var fromCodePoint =
                        require("../common/utils").fromCodePoint;
            ...
            50: [
                function (require, module, exports) {
                    ...
                    module.exports = function footnote_ref(state, silent) {
                        ...
                        if (
                            typeof state.env.footnotes.refs[":" + label] ===
                            "undefined"
                        ) {
                            return false;
                        }
                        ...
                        if (!silent) {
                            ...
                            if (state.env.footnotes.refs[":" + label] < 0) {
                                ...
                                state.env.footnotes.refs[":" + label] =
                                    footnoteId;
                            } else {
                                footnoteId =
                                    state.env.footnotes.refs[":" + label];
            ...
            52: [
                function (require, module, exports) {
                    ...
                    module.exports = function ins(state, silent) {
                        ...
                        while (state.pos + 1 < max) {
                            if (
                                state.src.charCodeAt(state.pos) === 0x2b /* + */
                            ) {
                                if (
                                    state.src.charCodeAt(state.pos + 1) ===
                                    0x2b /* + */
            ...
            54: [
                function (require, module, exports) {
                    ...
                    module.exports = function del(state, silent) {
                        ...
                        while (state.pos + 1 < max) {
                            if (
                                state.src.charCodeAt(state.pos) === 0x3d /* = */
                            ) {
                                if (
                                    state.src.charCodeAt(state.pos + 1) ===
                                    0x3d /* = */
                    ...
                    (function (root, factory) {
                        ...
                        Autolinker.prototype = {
                                        ...
                                        if (node.getTagName() === "a") {
                                            if (!node.isClosing()) {
                                                ...
                                                anchorTagStackCount = Math.max(
                                                    anchorTagStackCount - 1,
                                                    0
                                                ); // attempt to handle extraneous </a> tags by making sure the stack count never goes below 0
                                            }
                                        }
                            ...
                            createMatchReturnVal: function (match) {
                                ...
                                var replaceFnResult;
                                if (this.replaceFn) {
                                    replaceFnResult = this.replaceFn.call(
                                        this,
                                        this,
                                        match
                                    ); // Autolinker instance is the context, and the first arg
                                }
                            ...
                            getTagBuilder: function () {
                                ...
                                if (!tagBuilder) {
                                    tagBuilder = this.tagBuilder =
                                        new Autolinker.AnchorTagBuilder({
                        ...
                        Autolinker.Util = {
                            ...
                            extend: function (superclass, protoProps) {
                                ...
                                if (protoProps.hasOwnProperty("constructor")) {
                                    ...
                                    subclass = function () {
                                        superclassProto.constructor.apply(
                                            this,
                                            arguments
                                        );
                                    };
                            ...
                            ellipsis: function (
                                ...
                                if (str.length > truncateLen) {
                                    ...
                                    str =
                                        str.substring(
                                            0,
                                            truncateLen - ellipsisChars.length
                                        ) + ellipsisChars;
                                }
                                return str;
                            },
                        ...
                        Autolinker.HtmlTag = Autolinker.Util.extend(Object, {
                            ...
                            constructor: function (cfg) {
                                ...
                                this.innerHtml =
                                    this.innerHtml || this.innerHTML; // accept either the camelCased form or the fully capitalized acronym
                            },
                            ...
                            addClass: function (cssClass) {
                                var classAttr = this.getClass(),
                                    ...
                                    classes = !classAttr
                                        ? []
                                        : classAttr.split(whitespaceRegex),
                                    newClasses =
                                        cssClass.split(whitespaceRegex),
                                    newClass;
                            ...
                            removeClass: function (cssClass) {
                                ...
                                while (
                                    classes.length &&
                                    (removeClass = removeClasses.shift())
                                ) {
                         ...
                         *     //   Test <a href="http://google.com" target="_blank" rel="nofollow">google.com</a>
                         */
                        Autolinker.AnchorTagBuilder = Autolinker.Util.extend(
                            Object,
                            {
                                /**
                                 * @cfg {Boolean} newWindow
                                ...
                                createCssClass: function (matchType) {
                                    ...
                                    if (!className) return "";
                                        ...
                                        return (
                                            ...
                                            "-" +
                                            matchType
                                        ); // ex: "myLink myLink-url", "myLink myLink-email", or "myLink myLink-twitter"
                                },
                            ...
                            Autolinker.Util.extend(Object, {
                                ...
                                htmlRegex: (function () {
                                    var tagNameRegex =
                                            /[0-9a-zA-Z][0-9a-zA-Z:]*/,
                                        attrNameRegex =
                                            /[^\s\0"'>\/=\x01-\x1F\x7F]+/, // the unicode range accounts for excluding control chars, and the delete char
                                        attrValueRegex =
                                            /(?:"[^"]*?"|'[^']*?'|[^'"=<>`\s]+)/, // double quoted, single quoted, or unquoted attribute values
                                ...
                                parse: function (html) {
                                    ...
                                    while (
                                        (currentResult =
                                            htmlRegex.exec(html)) !== null
                                    ) {
                                        var tagText = currentResult[0],
                                            tagName =
                                                currentResult[1] ||
                                                currentResult[3], // The <!DOCTYPE> tag (ex: "!DOCTYPE"), or another tag (ex: "a" or "img")
                                            isClosingTag = !!currentResult[2],
                                            inBetweenTagsText = html.substring(
                                                lastIndex,
                                                currentResult.index
                                            );
                                ...
                                parseTextAndEntityNodes: function (text) {
                                    var nodes = [],
                                        textAndEntityTokens =
                                            Autolinker.Util.splitAndCapture(
                                                text,
                                    ...
                                    for (
                                        var i = 0,
                                            len = textAndEntityTokens.length;
                                        i < len;
                                        i += 2
                                    ) {
                                        var textToken = textAndEntityTokens[i],
                                            entityToken =
                                                textAndEntityTokens[i + 1];

                                        if (textToken)
                                            nodes.push(
                                                this.createTextNode(textToken)
                                            );
                                        if (entityToken)
                                            nodes.push(
                                                this.createEntityNode(
                                                    entityToken
                                                )
                                            );
                                    }
                         ...
                         */
                        Autolinker.htmlParser.HtmlNode = Autolinker.Util.extend(
                            Object,
                            {
                                /**
                            ...
                            Autolinker.Util.extend(Object, {
                                ...
                                matcherRegex: (function () {
                                    var twitterRegex = /(^|[^\w])@(\w{1,15})/, // For matching a twitter handle. Ex: @gregory_jacobs
                                        ...
                                        domainNameRegex =
                                            /[A-Za-z0-9\.\-]*[A-Za-z0-9\-]/, // anything looking at all like a domain, non-unicode domains, not ending in a period
                                        tldRegex =
                                    ...
                                    return text.replace(
                                        ...
                                        function (
                                            ...
                                            if (!matchDescObj) {
                                                ...
                                                var replaceStr = replaceFn.call(
                                                    contextObj,
                                                    matchDescObj.match
                                                );
                                                return (
                                                    matchDescObj.prefixStr +
                                                    replaceStr +
                                                    matchDescObj.suffixStr
                                                );
                                            }
                                        }
                                    );
                                ...
                                processCandidateMatch: function (
                                    ...
                                    // in the match itself.
                                    if (
                                        this.matchHasUnbalancedClosingParen(
                                            matchStr
                                        )
                                    ) {
                                        matchStr = matchStr.substr(
                                            0,
                                            matchStr.length - 1
                                        ); // remove the trailing ")"
                                 ...
                                 */
                                matchHasUnbalancedClosingParen: function (
                                    matchStr
                                ) {
                                    var lastChar = matchStr.charAt(
                                        matchStr.length - 1
                                    );
                                    ...
                                    if (lastChar === ")") {
                                        var openParensMatch =
                                            ...
                                            numOpenParens =
                                                (openParensMatch &&
                                                    openParensMatch.length) ||
                                                0,
                                            numCloseParens =
                                                (closeParensMatch &&
                                                    closeParensMatch.length) ||
                                                0;
                         ...
                         */
                        Autolinker.MatchValidator = Autolinker.Util.extend(
                            Object,
                            {
                                /**
                                 * @private
                                ...
                                isValidMatch: function (
                                    ...
                                    if (
                                        (protocolUrlMatch &&
                                            !this.isValidUriScheme(
                                                protocolUrlMatch
                                            )) ||
                                        this.urlMatchDoesNotHaveProtocolOrDot(
                                            urlMatch,
                                            protocolUrlMatch
                                        ...
                                        this.isInvalidProtocolRelativeMatch(
                                            protocolRelativeMatch
                                        ) // A protocol-relative match which has a word character in front of it (so we can skip something like "abc//google.com")
                                    ) {
                                        return false;
                                    }
                                 ...
                                 *   match.
                                 */
                                urlMatchDoesNotHaveProtocolOrDot: function (
                                    urlMatch,
                                    protocolUrlMatch
                                ) {
                                    return (
                                        !!urlMatch &&
                                        (!protocolUrlMatch ||
                                            !this.hasFullProtocolRegex.test(
                                                protocolUrlMatch
                                            )) &&
                                        urlMatch.indexOf(".") === -1
                                    );
                                ...
                                urlMatchDoesNotHaveAtLeastOneWordChar:
                                    function (urlMatch, protocolUrlMatch) {
                                        if (urlMatch && protocolUrlMatch) {
                                            return !this.hasWordCharAfterProtocolRegex.test(
                                                urlMatch
                                            );
                                        } else {
                                            return false;
                                 ...
                                 */
                                isInvalidProtocolRelativeMatch: function (
                                    protocolRelativeMatch
                                ) {
                                    return (
                                        !!protocolRelativeMatch &&
                                        this.invalidProtocolRelMatchRegex.test(
                                            protocolRelativeMatch
                                        )
                                    );
                                },
                         ...
                         */
                        Autolinker.match.Match = Autolinker.Util.extend(
                            Object,
                            {
                                /**
                         ...
                         */
                        Autolinker.match.Email = Autolinker.Util.extend(
                         ...
                         * See this class's superclass ({@link Autolinker.match.Match}) for more details.
                         */
                        Autolinker.match.Twitter = Autolinker.Util.extend(
                            Autolinker.match.Match,
                            {
                                /**
                         ...
                         * See this class's superclass ({@link Autolinker.match.Match}) for more details.
                         */
                        Autolinker.match.Url = Autolinker.Util.extend(
                            Autolinker.match.Match,
                            {
                                /**
                                ...
                                getAnchorText: function () {
                                    ...
                                    if (this.protocolRelativeMatch) {
                                        ...
                                        anchorText =
                                            this.stripProtocolRelativePrefix(
                                                anchorText
                                            );
                                    }
                                    if (this.stripPrefix) {
                                        anchorText =
                                            this.stripUrlPrefix(anchorText);
                                    }
                                    anchorText =
